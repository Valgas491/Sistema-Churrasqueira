...
namespace ExemploChurrasqueira.Module.Controllers.GlobalView {
    ...
    public partial class GlobalPreLoaderDetailVIew : ViewController<DevExpress.ExpressApp.View>{
        // Use CodeRush to create Controllers and Actions with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/403133/
        private IJSRuntime jsRuntime;
        public GlobalPreLoaderDetailVIew() { 
            InitializeComponent();
        ...
        private async void Escrever()
        {
            await Task.Delay(1000);
            string svgMarkup = @"
                <svg class=""loader-animado-logo"" version=""1.0"" xmlns=""http://www.w3.org/2000/svg"" viewBox=""-5030 -7538 14000 14000""
                 preserveAspectRatio=""xMidYMid meet"">
                <g transform=""translate(0, 2000) scale(0.3, -0.3)"" fill=""#000000"" stroke=""none"">
                    <path class=""central"" d=""M5700 14980 c-182 -12 -386 -43 -555 -84 -296 -73 -457 -137 -935
...
-56 -277 -158 -299 -158 -8 0 -11 676 -11 2470 l0 2470 410 0 410 0 0 -2110z"" />
                    <path class=""raquete"" d=""M6910 13163 c-175 -27 -354 -107 -453 -202 -85 -81 -166 -246 -203
...
-245 -22 -7 -22 -7 -22 133 l0 141 181 0 180 0 -21 -29z"" />
                    <path class=""mtc"" d=""M2700 7101 c-175 -37 -356 -136 -480 -261 -82 -82 -128 -153 -169
