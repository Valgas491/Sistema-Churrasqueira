...
namespace ExemploChurrasqueira.Blazor.Server.Templates
{
    public class Login : WindowTemplateBase
    {
        public Login()
        {
        ...
        protected override RenderFragment CreateComponent() => LoginComponent.Create(this);
